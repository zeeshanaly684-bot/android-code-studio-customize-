...
package com.tom.rv2ide.services.log
...
data class ConnectionObserverParams(val clientId: String, val totalConnections: Int) {
  ...
  companion object {
    ...
    const val KEY_CLIENT_ID = "com.tom.rv2ide.logreceiver.connectedClientId"
    const val KEY_CONNECTION_COUNT = "com.tom.rv2ide.logreceiver.connectionCount"
