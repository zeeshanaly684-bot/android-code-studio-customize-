...
interface ILanguageServer {
   ...
   * [getRootWorkspace()][com.tom.rv2ide.projects.IProjectManager.workspace] to obtain the workspace
   * instance.
   *
  ...
  suspend fun hover(params: DefinitionParams): com.tom.rv2ide.lsp.models.MarkupContent {
