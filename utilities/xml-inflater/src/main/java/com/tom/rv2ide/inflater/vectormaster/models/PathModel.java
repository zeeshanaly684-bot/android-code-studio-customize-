...
package com.tom.rv2ide.inflater.vectormaster.models;
...
import com.tom.rv2ide.inflater.vectormaster.DefaultValues;
import com.tom.rv2ide.inflater.vectormaster.utilities.Utils;
import com.tom.rv2ide.inflater.vectormaster.utilities.parser.PathParser;
...
public class PathModel {
  ...
  public void buildPath(boolean useLegacyParser) {
    if (useLegacyParser) {
      originalPath =
          com.tom.rv2ide.inflater.vectormaster.utilities.legacyparser.PathParser.createPathFromPathData(
              pathData);
    } else {
