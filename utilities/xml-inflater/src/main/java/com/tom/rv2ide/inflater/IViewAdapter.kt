 ...
 * - [ViewAdapter][com.tom.rv2ide.annotations.inflater.ViewAdapter] is used to specify the view
 *   whose attributes are handled by the view adapter implementation.
 * - [IncludeInDesigner][com.tom.rv2ide.annotations.uidesigner.IncludeInDesigner] is used to
...
abstract class IViewAdapter<T : View> : AbstractParser() {
   ...
   * [ViewAdapter][com.tom.rv2ide.annotations.inflater.ViewAdapter] annotation.
   *
