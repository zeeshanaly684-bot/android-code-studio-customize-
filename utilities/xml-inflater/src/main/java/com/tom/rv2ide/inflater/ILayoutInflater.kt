...
interface ILayoutInflater : Closeable {
   ...
   *
   * **NOTE** : The [startParse][com.tom.rv2ide.inflater.utils.startParse] method is called if it
   * hasn't been called yet. However, the [endParse] [com.tom.rv2ide.inflater.utils.endParse] method
   ...
   * [com.tom.rv2ide.inflater.utils.endParse].
   *
