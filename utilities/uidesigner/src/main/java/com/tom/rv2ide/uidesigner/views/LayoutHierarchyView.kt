...
package com.tom.rv2ide.uidesigner.views
...
constructor(
  ...
  private fun addViews(view: IView, depth: Int) {
    ...
    if (view is com.tom.rv2ide.inflater.IViewGroup) {
  ...
  private fun computeChildCount(view: com.tom.rv2ide.inflater.IViewGroup): Int {
    var count = view.childCount
    view.forEachIndexed { index, child ->
      if (index != view.childCount - 1 && child is com.tom.rv2ide.inflater.IViewGroup) {
