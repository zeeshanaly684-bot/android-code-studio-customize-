...
package com.tom.rv2ide.uidesigner.adapters
...
import com.tom.rv2ide.inflater.IView.SingleAttributeChangeListener
import com.tom.rv2ide.uidesigner.R
import com.tom.rv2ide.uidesigner.adapters.ViewAttrListAdapter.VH
import com.tom.rv2ide.uidesigner.databinding.LayoutViewattrItemBinding
import com.tom.rv2ide.uidesigner.models.UiAttribute
...
internal class ViewAttrListAdapter(
    attributes: List<com.tom.rv2ide.inflater.IAttribute>,
    private val viewModel: WorkspaceViewModel?,
    private val onDeleteAttr: (com.tom.rv2ide.inflater.IAttribute) -> Boolean,
    private val onClick: (com.tom.rv2ide.inflater.IAttribute) -> Unit,
      ...
      val attrUpdateListener =
          object : SingleAttributeChangeListener() {
            override fun onAttributeUpdated(
                ...
                attribute: com.tom.rv2ide.inflater.IAttribute,
                oldValue: String,
            ) {
