...
import com.tom.rv2ide.inflater.internal.NamespaceImpl
import com.tom.rv2ide.uidesigner.models.UiAttribute
import com.tom.rv2ide.uidesigner.models.UiView
 ...
 * @author Akash Yadav
 */
open class UiInflaterComponentFactory : com.tom.rv2ide.inflater.IComponentFactory {

  override fun createView(
      file: LayoutFile,
      name: String,
      view: View,
  ): com.tom.rv2ide.inflater.IView {
  ...
  override fun createAttr(
      ...
      name: String,
      value: String,
  ): com.tom.rv2ide.inflater.IAttribute {
