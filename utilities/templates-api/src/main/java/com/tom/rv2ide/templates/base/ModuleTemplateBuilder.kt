...
import com.tom.rv2ide.templates.base.models.Dependency
import com.tom.rv2ide.templates.base.models.defaultDependency
...
abstract class ModuleTemplateBuilder :
   ...
   */
  open fun baseAsset(path: String) = com.tom.rv2ide.templates.base.util.baseAsset("module", path)
   ...
   * [Implementation][com.tom.rv2ide.templates.base.models.DependencyConfiguration.Implementation]
   * configuration.
   *
