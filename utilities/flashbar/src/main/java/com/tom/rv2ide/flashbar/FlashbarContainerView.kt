package com.tom.rv2ide.flashbar
...
import com.tom.rv2ide.flashbar.Flashbar.Companion.DURATION_INDEFINITE
import com.tom.rv2ide.flashbar.Flashbar.DismissEvent
import com.tom.rv2ide.flashbar.Flashbar.DismissEvent.*
import com.tom.rv2ide.flashbar.Flashbar.Gravity.BOTTOM
import com.tom.rv2ide.flashbar.Flashbar.Gravity.TOP
import com.tom.rv2ide.flashbar.Flashbar.OnBarDismissListener
import com.tom.rv2ide.flashbar.Flashbar.OnBarShowListener
import com.tom.rv2ide.flashbar.Flashbar.OnTapListener
import com.tom.rv2ide.flashbar.Flashbar.Vibration
import com.tom.rv2ide.flashbar.Flashbar.Vibration.DISMISS
import com.tom.rv2ide.flashbar.Flashbar.Vibration.SHOW
import com.tom.rv2ide.flashbar.SwipeDismissTouchListener.DismissCallbacks
import com.tom.rv2ide.flashbar.anim.FlashAnim
import com.tom.rv2ide.flashbar.anim.FlashAnimBarBuilder
import com.tom.rv2ide.flashbar.anim.FlashAnimIconBuilder
import com.tom.rv2ide.flashbar.util.NavigationBarPosition.*
import com.tom.rv2ide.flashbar.util.afterMeasured
import com.tom.rv2ide.flashbar.util.getNavigationBarPosition
import com.tom.rv2ide.flashbar.util.getNavigationBarSizeInPx
import com.tom.rv2ide.flashbar.util.getRootView
...
internal class FlashbarContainerView(context: Context) : RelativeLayout(context), DismissCallbacks {
  ...
  internal fun adjustOrientation(activity: Activity) {
    ...
    when (navigationBarPosition) {
      ...
      com.tom.rv2ide.flashbar.util.NavigationBarPosition.TOP ->
          flashbarContainerViewLp.topMargin = navigationBarSize
      RIGHT -> flashbarContainerViewLp.rightMargin = navigationBarSize
      com.tom.rv2ide.flashbar.util.NavigationBarPosition.BOTTOM ->
