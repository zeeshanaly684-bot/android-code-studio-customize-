...
import com.tom.rv2ide.lsp.java.providers.CompletionProvider.MAX_COMPLETION_ITEMS
...
import com.tom.rv2ide.utils.ClassTrie.Node
...
class ImportCompletionProvider(
   ...
   */
  private fun collectPackageNode(trie: com.tom.rv2ide.utils.ClassTrie, pkgName: String): Node? {
