...
import com.tom.rv2ide.lsp.java.actions.FieldBasedAction
import com.tom.rv2ide.lsp.java.compiler.CompileTask
import com.tom.rv2ide.lsp.java.utils.EditHelper
import com.tom.rv2ide.lsp.java.utils.ShortTypePrinter.NO_PACKAGE
...
class GenerateConstructorAction : FieldBasedAction() {
  ...
  private fun generateConstructor(data: ActionData, selected: MutableSet<String>) {
    ...
    val range = data[com.tom.rv2ide.models.Range::class.java]!!
  ...
  private fun generateForFields(
    ...
    val stopWatch = com.tom.rv2ide.utils.StopWatch("generateConstructorForFields()")
    val constructor =
