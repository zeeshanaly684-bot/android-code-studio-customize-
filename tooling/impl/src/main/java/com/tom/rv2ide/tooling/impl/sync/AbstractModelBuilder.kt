...
import com.tom.rv2ide.builder.model.IDESyncIssue
import com.tom.rv2ide.tooling.api.messages.InitializeProjectParams
import com.tom.rv2ide.tooling.api.util.ToolingProps
import com.tom.rv2ide.utils.AndroidPluginVersion
import com.tom.rv2ide.utils.AndroidPluginVersion.Companion.MINIMUM_SUPPORTED
...
abstract class AbstractModelBuilder<P, R>(
  ...
  companion object {
     ...
     * [ generateMessage(Object...)][com.tom.rv2ide.utils.ILogger.generateMessage] in
     * [ILogger][com.tom.rv2ide.utils.ILogger].
     *
