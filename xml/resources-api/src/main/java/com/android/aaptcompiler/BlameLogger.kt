...
fun blameSource(source: Source, line: Int? = source.line, column: Int? = null): BlameLogger.Source =
    BlameLogger.Source(source.path, line ?: -1, column ?: -1)

fun blameSource(source: Source, location: Location): BlameLogger.Source =
