 ...
 * bits [58:0] represent the basic fraction. The 59th bit is guaranteed to be set in this format and
 * is the highest order set bit.
 *
 ...
 *
 * Long values are used has they have an overwhelmingly higher precision than floats guaranteeing a
 ...
 * us to take the advantage of Long precision while still allowing computation to be quick.
 *
 * Long values are used as they have an overwhelmingly higher precision than floats guaranteeing a
 * lower margin of error.
 *
 * These values were generated.
 */
