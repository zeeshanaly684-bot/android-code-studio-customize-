 ...
 *
 * XID_Start is a Unicode Derived Core Property. It is a variation of the ID_Start Derived Core
 * Property, accounting for a few characters that, when normalized, yield valid characters in the
 * ID_Start set.
 */
 ...
 * http://unicode.org/reports/tr31/#Default_Identifier_Syntax
 *
 * XID_Continue is a Unicode Derived Core Property. It is a variation of the ID_Continue Derived
 * Core Property, accounting for a few characters that, when normalized, yield valid characters in
 * the ID_Continue set.
 */
fun isXidContinue(utf32: Int): Boolean = (findCharacterProperties(utf32) and XID_CONTINUE_FLAG) != 0

/**
 * Returns true if the UTF8 string can be used as a Java identifier. NOTE: This does not check
 * against the set of reserved Java keywords.
 */
...
/**
 * Returns true if the UTF8 string can be used as the entry name of a resource name. This is the
 * `entry` part of package:type/entry.
 */
