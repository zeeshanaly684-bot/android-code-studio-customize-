...
class AppIntroFragment : AppIntroBaseFragment() {
  ...
  companion object {
     ...
     * @param imageDrawable @DrawableRes (Integer) the image that will be displayed, obtained from
     *   Resources
     ...
     * @param titleTypefaceFontRes @FontRes (Integer) custom title typeface obtained from Resources
