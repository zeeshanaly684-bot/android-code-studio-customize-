...
package com.tom.rv2ide.build.propparser.gen;

import static java.util.stream.Collectors.toList;

import com.tom.rv2ide.build.propparser.parser.Message;
import com.tom.rv2ide.build.propparser.parser.MessageFile;
import com.tom.rv2ide.build.propparser.parser.MessageInfo;
import com.tom.rv2ide.build.propparser.parser.MessageLine;
import com.tom.rv2ide.build.propparser.parser.MessageType;
import com.tom.rv2ide.build.propparser.parser.MessageType.CompoundType;
import com.tom.rv2ide.build.propparser.parser.MessageType.CustomType;
import com.tom.rv2ide.build.propparser.parser.MessageType.SimpleType;
import com.tom.rv2ide.build.propparser.parser.MessageType.UnionType;
import com.tom.rv2ide.build.propparser.parser.MessageType.Visitor;
